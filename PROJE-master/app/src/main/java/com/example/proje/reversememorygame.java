...
public class reversememorygame extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reversememorygame);
    ...
    private void shownexti() {
        if (index < 10) {
            ...
            guessinput.setHint(getString(R.string.memorygameanswerhint, getOrdinal(11-index2)));
        }
    }
    ...
    private void check() {
        ...
        if (guess.isEmpty()) {
            ...
            if (index2 <= 10 && orderofint[10-index2] == answer) {
    ...
    private void end(){
        ...
        String rMemoryScore=score+"/100";
        Map<String,Object> rMemoryInfo=new HashMap<>();
        rMemoryInfo.put("reverseMemoryScore",rMemoryScore);
        mFirestore.collection("Users").document(UID).update(rMemoryInfo);
    }
    ...
    private void reset() {
        ...
        randomarray();
        numbertext.setVisibility(View.VISIBLE);
        numbertext.setText(String.valueOf(orderofint[9-index]));
    }
